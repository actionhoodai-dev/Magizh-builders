...
const services = [
    ...
    },
    {
        ...
        desc: 'Turnkey residential and villa construction services delivered with engineering precision.',
        seoTitle: 'Construction Company'
    },
    {
        id: 'interior',
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-serif text-primary font-bold mb-12 leading-tight">
                            Premier <span className="text-accent italic">Construction & Engineering</span> <br />Solutions We Deliver
                        </h2>
